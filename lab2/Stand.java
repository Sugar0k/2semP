...
public class Stand implements Comparable <Stand> {
    ...
    private final static String lab1_1_FORMAT_STRING = "%5s, %5s, %5s, %10s, %15s";
    ...
    public Stand(int length, int width, int weight, String material) {
        this.length = length;
        this.width = width;
        this.weight = weight;
    ...
    public int compareTo(Stand obj) {
